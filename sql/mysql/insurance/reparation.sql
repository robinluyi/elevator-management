...
CREATE TABLE `insurance_reparation`  (
  ...
  `total_price` bigint DEFAULT 0 COMMENT '配件总价格',
  `part_name` varchar(63) NOT NULL COMMENT '配件名称',
  `part_unit_id` tinyint NOT NULL COMMENT '单位',
  `part_unit_pirce` int NOT NULL COMMENT '单价',
  `part_quantity` int NOT NULL COMMENT '数量',
  `part_total` tinyint NOT NULL COMMENT '小计',
  ...
  `fault_pic_2` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  COMMENT '故障现场照片',
  -- 业务字段结束.
